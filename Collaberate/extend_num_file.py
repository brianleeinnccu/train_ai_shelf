...
#4170 ~ 6169 (共 2085 筆)
start_id = 0     # 起始位置 (包含)
end_id = 2084   # 結束位置 (不包含此行，所以會刪除 0 ~ 2084，共 2085 筆)
...
print(f"🎯 準備查找範圍：從 index {start_id} 到 {end_id} 的標註檔...\n")
...
for line in lines_to_delete:
    ...
    label_file = target_labels_dir / f"{base_name}.txt"
...
print(f"🗑️ {start_id} ~ {end_id}  成功了 {count} 個標註檔。") #360 2085 200
